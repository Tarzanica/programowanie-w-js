...
var QueryManager = /** @class */ (function () {
    function QueryManager() {
        ...
        this.onEntityStoresChanged = function (entity) {
            var e_3, _a;
            logger_1.logger.debug("Entity stores changed: " + entity.id);
            try {
                // FIXME: perf?
                for (var _b = __values(Object.values(_this.queryCache)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var query = _c.value;
    ...
    QueryManager.prototype.create = function (userDef) {
        ...
        var key = queries_1.Query.defToKey(def);
        if (!this.queryCache[key]) {
            this.queryCache[key] = new queries_1.Query(def);
        }
        // evaluate all existing entities
        this.__game.entities.entityList.forEach(function (entity) {
